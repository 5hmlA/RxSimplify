package yun.yalantis.ucrop.view.widget;
...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(yun.picker.simplify.R.color.ucrop_color_progress_wheel_line));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), yun.picker.simplify.R.color.ucrop_color_progress_wheel_line);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(yun.picker.simplify.R.dimen.ucrop_width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(yun.picker.simplify.R.dimen.ucrop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(yun.picker.simplify.R.dimen.ucrop_margin_horizontal_wheel_progress_line);
